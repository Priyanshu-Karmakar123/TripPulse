...
The day consists of TWO DISTINCT PHASES:
...
Compute:
origin_ready_time =
previous_stay_end + 30-minute stay + 30-minute buffer

You MUST NOT:
- Recompute previous_stay_end
- Normalize or round it
...
EXAMPLE 1 — EARLY DEPARTURE (DESTINATION-HEAVY)

PLAN
{
  "current_city": "from CityA to CityB",
  "transportation": "Departure Time: 06:00, Arrival Time: 08:57",
  "breakfast": "-",
  "lunch": "Lunch X",
  "dinner": "Dinner Y",
...
EXAMPLE 2 — MID DEPARTURE (1 ORIGIN + 1 DESTINATION ATTRACTION)

PLAN
{
  "transportation": "Departure Time: 11:30, Arrival Time: 14:30",
...
Attraction O, visit from 09:00 to 11:00;
...
EXAMPLE 3 — LATE DEPARTURE (2 ORIGIN ATTRACTIONS)

PLAN
{
  "transportation": "Departure Time: 18:30, Arrival Time: 22:15",
...
OUTPUT
Hotel A, stay from 08:00 to 08:30;
Attraction O1, visit from 09:00 to 11:00;
Attraction O2, visit from 11:30 to 13:30;
Hotel B, stay from 22:45 to 23:15;
Hotel B, stay from 23:15 to 08:00;

----------------------------------------------------

EXAMPLE 4 — NO ATTRACTIONS, STAYS ONLY

PLAN
{
  "transportation": "Departure Time: 07:00, Arrival Time: 23:00",
  "attraction": "-",
  "accommodation": "Hotel B"
}
...
"""
        ...
        if day_type == "LAST_DAY" and prev_day:
            temporal_context = f"""
====================================================
PREVIOUS DAY (FOR CHECKOUT CONTEXT)
====================================================
...
"""
    ...
    def generate_poi_list(
        ...
        for idx, original_day in enumerate(days):
            ...
            prev_day = result.get(idx) if idx > 0 else None
            ...
            prompt = self.build_prompt(
                ...
                prev_day=prev_day if prev_day else None,
            )
            ...
            # --------------------------------------------------
            prompt_dir = (
                Path("/scratch////output_agentic/agentic")
                / "qwen2.5"
                / "3day"
                / "1"
            )
