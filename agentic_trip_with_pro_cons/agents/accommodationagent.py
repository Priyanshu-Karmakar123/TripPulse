...
class AccommodationAgent:
    ...
    def __init__(self, llm):
        ...
        review_path = os.path.abspath(
            os.path.join(
                BASE_DIR,
                "../../_database/review_pro_cons/accomodation_review_pro_cons.csv"
            )
        )
    ...
    def get_accommodations_for_city(
        ...
        CSV_PATH = os.path.abspath(
            os.path.join(
                BASE_DIR,
                "../../_database/accommodation/cleaned_listings_final_v2.csv"
            )
        )
...
"""
    ...
    def match_hotel(self, selected, ref_list):
        ...
        def normalize(s):
            ...
            return s.strip()
        for h in ref_list:
            name_ok = normalize(h.get("name")) == normalize(sel_name)
